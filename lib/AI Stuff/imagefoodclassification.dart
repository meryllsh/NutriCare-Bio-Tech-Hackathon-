...
class _FoodClassificationState extends State<FoodClassification> {
  ...
  Future<void> FileImageRecognition() async {
    try {
      final ByteData data = await rootBundle.load('assets/nutricaretitle.png');
      final Uint8List imageBytes = data.buffer.asUint8List();
      _runModelOnImage(imageBytes);
    } catch (e) {
      print('Failed to load asset image: $e');
    }
  }
        ...
        child: Column(
          ...
          children: [
            ...
            ElevatedButton(
              ...
              child: Text('Run Model on Asset Image'),
            ),
            SizedBox(height: 20),
            Text(
